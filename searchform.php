...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php esc_attr_e( 'Search listings&hellip;', 'directoryx-adult' ); ?>" value="<?php echo get_search_query(); ?>" name="s" autocomplete="off">
	</label>
